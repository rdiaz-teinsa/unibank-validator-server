...
let result = exportExcelToTxt("/var/teinsa/unibank-validator-server/archive/data/236/20250101/AT04.xls", "/var/teinsa/unibank-validator-server/archive/data/236/20250101/AT04.txt", "~");
