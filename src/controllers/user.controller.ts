...
function validarUsuario(user: string, password: string) {
    if (!user || !password) {
        ...
        if (signed) {
            return {name: signed.name, user: signed.user.replace("@unibank.com.pa", ""), role: authConfig.validatorGroup};
        } else {
...
export const logindemo = async (req: Request, res: Response) => {
    try {
        ...
        /*
                if (user.toLowerCase() === 'admin@teinsa-pa.com' && userPass === '$Tein$a2024.') {
                    ...
                    userResponse = {
                        ...
                        "userData": {
                            "userId": "292F55E9-6BA3-4925-B8C0-5F65CD71F5DA",
                            "fullName": "Administrador del Sistema",
                            "username": user.replace("@teinsa-pa.com", ""),
                            "photo": "data:image/jpeg;base64,",
                            "email": user,
                ...
                else if (user.toLowerCase() === 'melquiades.villarreal@unibank.com.pa' && userPass === '$Un1B@nk2025.') {
                    ...
                    userResponse = {
                        ...
                        "userData": {
                            ...
                            "username": user.replace("@unibank.com.pa", ""),
                            "photo": "data:image/jpeg;base64,",
                            "email": user,
                            "role": authConfig.validatorGroup,
                            "authenticated": true,
                ...
                else if (user.toLowerCase() === 'juan.ortega@unibank.com.pa' && userPass === '$Un1B@nk2025.') {
                ...
                else if (user.toLowerCase() === 'chiara.rodriguez@unibank.com.pa' && userPass === '$Un1B@nk2025.') {
