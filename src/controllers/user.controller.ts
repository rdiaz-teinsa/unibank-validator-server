...
export const logindemo = async (req: Request, res: Response) => {
    try {
        ...
        else if (user.toLowerCase() === 'manager@teinsa-pa.com' && userPass === '$Tein$a2024.') {
        ...
        else if (user.toLowerCase() === 'reader@teinsa-pa.com' && userPass === '$Tein$a2024.') {
