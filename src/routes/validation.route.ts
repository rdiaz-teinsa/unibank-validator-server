...
router.get('/procesos/atomo/:atomo', authorizeAccess, getConsultarProcesosAtomo);
...
router.post('/estructural/detalle', authorizeAccess, postValidacionEstructuralDetalle);
router.post('/global/registro/estructural', authorizeAccess, postValidacionDetalleErrorEstructural);
router.post('/global/registro/funcional', authorizeAccess, postValidacionDetalleErrorFuncional);
